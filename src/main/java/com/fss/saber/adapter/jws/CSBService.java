...
package com.fss.saber.adapter.jws;
...
@WebServiceClient(name = "CSB_Service", targetNamespace = "http://aeps.Csbemvonline.in/", wsdlLocation = "http://10.44.167.10/AEPS/Services/CSB_Service.asmx?wsdl")
public class CSBService extends Service {
	...
	static {
		...
		try {
			url = new URL("http://10.44.167.10/AEPS/Services/CSB_Service.asmx?wsdl");
